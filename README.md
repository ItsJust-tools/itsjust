...
| **Blob Generator** | Generate organic SVG blob shapes | [blob-generator.itsjust.tools](https://blob-generator.itsjust.tools) |
...
| **Template** | Starter repo for building new tools | — |
...
| **System Config Builder** | Build system configuration files visually | [system-config-builder.itsjust.tools](https://system-config-builder.itsjust.tools) |
...
Deployed on **Vercel** via a `*.itsjust.tools` wildcard domain.

## 🤝 Contributing

**New tool ideas** — check the [Roadmap Board](https://github.com/orgs/ItsJust-tools/projects/2) for planned tools. Add issues for new ideas.
